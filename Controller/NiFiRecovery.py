...
def recoveryVarian(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        pg_id = RecoveryModel.processGroup(params, headers, data)
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/varian',
        ...
        http_id =RecoveryModel.precessorInvokeHTTP(params, headers, pg_id, data)

        ## CREATE PROCESSOR LOG ATTRIBUTE
        log_original_id = RecoveryModel.processorLogAttribute_original(params, headers, pg_id)
        conn_original_id = RecoveryModel.connection_original(params, headers, pg_id, http_id, log_original_id)

        log_retry_id = RecoveryModel.processorLogAttribute_retry(params, headers, pg_id)
        conn_retry_id = RecoveryModel.connection_retry(params, headers, pg_id, http_id, log_retry_id)

        log_failure_id = RecoveryModel.processorLogAttribute_failure(params, headers, pg_id)
        conn_failure_id = RecoveryModel.connection_failure(params, headers, pg_id, http_id, log_failure_id)

        log_response_id = RecoveryModel.processorLogAttribute_response(params, headers, pg_id)
        conn_response_id = RecoveryModel.connection_response(params, headers, pg_id, http_id, log_response_id)

        log_no_retry_id = RecoveryModel.processorLogAttribute_no_retry(params, headers, pg_id)
        conn_no_retry_id = RecoveryModel.connection_no_retry(params, headers, pg_id, http_id, log_no_retry_id)

        print(pg_id)
        print(process_group_name)

        RecoveryModel.change_pg_state(params, headers, pg_id, state)
...
def recoverySubVarian(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/sub_varian',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryProduk(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/produk',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryAkunting(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/akunting',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryBusiestItemTime(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/busiest_item_time',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryCompliment(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/compliment',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryOutletSales(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/outlet_sales',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryProductSales(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/product_sales',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoverySummaryReservation(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/summary_reservation',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryTransactionType(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/transaction_type',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
...
def recoveryUtilization(resource, params, headers, state, x, y):
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'https://data-validity.majoo.id/recovery/rawmart/utilization',
            'connection_timeout': '1200 secs',
            'read_timeout': '1200 secs',
            'max_idle_connection': 1,
            'idle-timeout': '10 mins',
