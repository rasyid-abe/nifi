...
def sequence15min(resource, params, headers, state, x, y):
    process_group_name = "ETL MART SalesItem Seq15Min - Postgres"
    ...
    if s < 1:
        ...
        data = {
            ...
            'http_name': http_name,
            'http_method': 'GET',
            'remote_url': 'http://10.130.248.133:8001/mart/sales/product-sequence-min?sequence=15',
